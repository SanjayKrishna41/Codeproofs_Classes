...
public class TeacherChangePasswordFragment extends Fragment implements View.OnClickListener {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_teacher_changepassword, container, false);
        ...
        if (v.getId() == R.id.stdchangeButton) {
            ...
            if (oldPass.equals("") || newPass.equals("") || reType.equals("")) {
                ...
                try {
                    ...
                    backgroundWork.execute("changepassword", newPass, userid.trim());
                } catch (Exception e) {
    ...
    public class BackgroundWork extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String teachid = params[2];

            if (type.equals("changepassword")) {
                String loginUrl = "http://codeproofs.com/classes/Android/teacherchangepassword.php";
                try {
                    ...
                    String postData = URLEncoder.encode("password", "UTF-8") + "=" + URLEncoder.encode(newpass, "UTF-8") + "&" +
                            URLEncoder.encode("teachid", "UTF-8") + "=" + URLEncoder.encode(teachid.trim(), "UTF-8");
